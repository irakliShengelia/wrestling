<template>
  ...
  <section class="py-16 px-6 bg-white text-left max-w-4xl mx-auto">
  ...
  <section class="py-16 px-6 bg-gray-100 text-left max-w-4xl mx-auto">
  ...
  <section class="py-16 px-6 bg-white text-left max-w-4xl mx-auto shadow-lg rounded-lg">
    ...
    <div class="mt-8">
      ...
      <p class="text-gray-800 mt-4"><strong>Accommodation:</strong> Rooms Hotel Kazbegi or local guesthouse (twin/double occupancy).</p>
    </div>
  ...
  <section id="booking" class="py-16 px-6 bg-blue-600 text-white text-left max-w-4xl mx-auto">
